...
function setup(){
    ...
    boyQ = createSprite(width/3 - 100, height/4 + 40,120,150);
    boyQ.addImage("boy", boyQImg);
    boyQ.visible = false;

    clockQ = createSprite(width/3 + 100, height/4 + 40,120,150);
    clockQ.addImage("clock", clockQImg);
    clockQ.visible = false;

    doorQ = createSprite(width/3 + 400, height/4 + 40,120,150);
